...
export default function VendrOSSection() {
  ...
  return (
    <section className="relative py-16 sm:py-24 lg:py-32 section-pattern">
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              variants={itemVariants}
            >
              <Button asChild className="purple-button w-full sm:w-auto">
                <Link href="/pricing">
                  Start Your Journey
              ...
              <Button asChild variant="outline" className="secondary-button w-full sm:w-auto">
                <Link href="/contact">
                  Learn More
                </Link>
              </Button>
          ...
          <motion.div
            ...
            animate={isInView ? "visible" : "hidden"}
          >
            <div className="relative rounded-2xl overflow-hidden glass-effect p-4 sm:p-6 glow-effect">
            ...
            <div className="absolute -top-3 -right-3 sm:-top-6 sm:-right-6 w-16 h-16 sm:w-24 sm:h-24 bg-primary/10 rounded-full blur-2xl"></div>
            <div className="absolute -bottom-3 -left-3 sm:-bottom-6 sm:-left-6 w-20 h-20 sm:w-32 sm:h-32 bg-primary/5 rounded-full blur-3xl"></div>
          </motion.div>
        </div>
      </Wrapper>
    </section>
